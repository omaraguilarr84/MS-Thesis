...
parfor idx = 1:numCombinations
    ...
    try
        tform = imregtform(movingImageBW_down, ref2_down, fixedImageBW_down, ref1_down, 'similarity', optimizer, metric);
...
tform = imregtform(movingImageBW_down, ref2_down, fixedImageBW_down, ref1_down, 'similarity', optimizer, metric, 'DisplayOptimization', true);
